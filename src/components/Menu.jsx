  ...
  return (
    ...
    <div className='flex  lg:flex-row w-fit  gap-5 '>
      <div>
        ...
        <Link to='/education' className='flex flex-row lg:gap-3 hover:text-green-500 rounded-xl p-1 text-blue-600 '>Academics<span className='lg:pt-2  '><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
